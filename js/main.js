...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const end = new Date("2026-01-25T00:00:00+08:00").getTime(); // 25 Jan 2026, 12AM MYT
...
// Set a fixed end date: 25 Januari 2026 at 9:00 AM UTC
const endDate = "20260125T090000Z";

const event = {
    title: "Jemputan Kenduri Kahwin Ain & Aiman",
    startDate: startDate,
    endDate: endDate,
    location: "Mutiara Garden Hall, Seberang Balok, Kuantan.",
    description: "Majlis perkahwinan Nurain dan Muhammad Aiman.",
};
...
function openGoogleMaps() {
    const latitude = 3.9570220863499106;  // Example latitude 
    const longitude = 103.38930309885552;  // Example longitude
...
function openWaze() {
    const latitude = 3.957132; 
    const longitude = 103.389201;
...
function openWhatsApp(phoneNumber) {
    const message = "Hello dan Salam Sejahtera, saya nak tanya berkenaan majlis perkahwinan Nurain dan Muhammad Aiman.";
